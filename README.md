...
- DEV (`npm run dev`), currently experimental and requires development environment setup as described [above](https://github.com/i7en0v91/travel-agency-website/tree/sass#setting-up-development-environment)
