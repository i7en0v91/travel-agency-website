import { AvailableTokenKinds, AvailableEmailTemplates, AvailableAirplaneImageKind, AvailableFlightClasses, AvailableStayDescriptionParagraphTypes, AvailableStayServiceLevel, type EntityId } from "@golobe-demo/shared";
