import { flattenError, AppConfig, wrapLogDataArg, getAppExceptionCustomLogLevel, getErrorAppExceptionCode, type IAppLogger } from '@golobe-demo/shared';
...
export class ServerLogger implements IAppLogger {
  ...
  constructor () {
    this.winstonLogger = createLoggerSync();
  }
