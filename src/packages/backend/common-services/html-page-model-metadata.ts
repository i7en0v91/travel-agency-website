import { type PageCacheVaryOptions, AppException, AppExceptionCodeEnum, type AppPage, type IAppLogger } from '@golobe-demo/shared';
import { emailVerifyCompleteAllowedParamsOptions, findFlightsAllowedParamsOptions, findStaysAllowedParamsOptions, flightsAllowedParamsOptions, forgotPasswordCompleteCacheParamsOptions, forgotPasswordSetAllowedParamsOptions, previewSystemParamOptions, internalSystemParamOptions, loginPageAllowedParamsOptions, signUpCompleteAllowedParamsOptions, stayBookAllowedParamsOptions, staysAllowedParamsOptions, timestampSystemParamOptions, type AccountCacheParams, type BookFlightCacheParams, type BookStayCacheParams, type BookingCacheParams, type BookingDetailsAllowedParamsOptions, type EmailVerifyCompleteAllowedParamsOptions, type EmailVerifyCompleteCacheParams, type FavouritesCacheParams, type FindFlightsAllowedParamsOptions, type FindFlightsCacheParams, type FindStaysAllowedParamsOptions, type FindStaysCacheParams, type FlightDetailsCacheParams, type FlightsAllowedParamsOptions, type FlightsCacheParams, type ForgotPasswordCacheParams, type ForgotPasswordCompleteCacheParams, type ForgotPasswordCompleteCacheParamsOptions, type ForgotPasswordSetAllowedParamsOptions, type ForgotPasswordSetCacheParams, type ForgotPasswordVerifyCacheParams, type GetHtmlPageCacheObjType, type IndexCacheParams, type LoginCacheParams, type LoginPageAllowedParamsOptions, type PrivacyCacheParams, type SignupCacheParams, type SignupCompleteAllowedParamsOptions, type SignupCompleteCacheParams, type SignupVerifyCacheParams, type StayBookAllowedParamsOptions, type StayDetailsCacheParams, type StaysAllowedParamsOptions, type StaysCacheParams, bookingDetailsAllowedParamsOptions } from './../page-query-params';
import { type ParseQueryCacheResult, type GetCachePageParamListObj, type GetParamsOptionsResult, type NormalizedQueryResult, type GetParamsOptionsKind, type CacheParamsVariedByValueRanges, type CacheParamsVariedBySystemParamsOnly, type CacheByPageTimestamp, type EmptyParamListOptions, type CachePageParamOptions, type CacheablePageParamsBase, type GetCachePageParamsVaryMode, type SystemQueryParamsListOptions, type ParseQueryCacheError, type ParseQueryCacheRedundantParam, type ParseQueryCacheRequiredParamMissed, type ParseQueryCacheSuccess, type ParseQueryCacheValueNotAllowed } from './../types';
