...
const HtmlPageCachingRules: { [P in AppPage]: NitroRouteConfig } & { [P in SystemPage]: NitroRouteConfig } = {
  ...
  'Signup': getRouteCachingRule(true, true),
  'ForgotPassword': getRouteCachingRule(true, true),
  ...
  'Login': getRouteCachingRule(false, true), // KB: safer to disable caching for this page
  'Privacy': getRouteCachingRule(true, false),
  ...
  'SignupVerify': getRouteCachingRule(true, true),
  'SignupComplete': getRouteCachingRule(false, true),
  'ForgotPasswordVerify': getRouteCachingRule(true, true),
  'ForgotPasswordComplete': getRouteCachingRule(true, true),
