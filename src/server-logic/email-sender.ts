...
export class EmailSender implements IEmailSender {
  ...
  createMailTemplateParams = async (kind: EmailTemplate, params: IEmailParams): Promise<IMailTemplateParams> => {
    ...
    if (params.token) {
      ...
      pageLinkQuery = withQuery(joinURL(localeSegment, pageUrlSegment), { token_id: params.token.id, token_value: params.token.value });
    }
