import { type IStayOffer, type IAppLogger, type EntityId, type IFlight, type IFlightOffer, type EntityDataAttrsOnly, type PreviewMode } from '../app-facade/interfaces';
import { buildStayOfferUniqueDataKey, buildFlightUniqueDataKey, buildFlightOfferUniqueDataKey, newUniqueId, DbVersionInitial } from '../app-facade/implementation';
import flatten from 'lodash-es/flatten';
import type { PrismaClient } from '@prisma/client';
import { mapDate } from '../helpers/db';
import keys from 'lodash-es/keys';
import uniqBy from 'lodash-es/uniqBy';
import { type IFlightOfferMaterializer, type IStayOfferMaterializer } from './../helpers/offer-materializers';
