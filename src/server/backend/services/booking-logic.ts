...
import { type IAppLogger, type IStaysLogic, type EntityId, type IStayOfferDetails, type IBookingLogic, type IFlightOffer, type IOfferBooking, type IOfferBookingData, type EntityDataAttrsOnly } from './../../backend/app-facade/interfaces';
