...
import { type IImageData, type IAppLogger, type EntityId, type IAuthFormImageLogic, type IAuthFormImageInfo, type AuthFormImageData, type IImageLogic } from '../app-facade/interfaces';
import { DbVersionInitial, ImageCategory, newUniqueId } from '../app-facade/implementation';
...
export class AuthFormImageLogic implements IAuthFormImageLogic {
  ...
  async createImage(imageData: AuthFormImageData | EntityId, order: number, event: H3Event): Promise<EntityId> {
