  ...
  ? ({
      ...
      details: {
        ...
        items: offerData.kind === 'flights'
          ? ([
              { ctrlKey: [...CtrlKey, 'Ticket', 'Details', 'Dates'] as ControlKey, caption: getI18nResName3('ticket', 'details', 'date'), icon: 'calendar', text: d(getValueForFlightDayFormatting((offerData as EntityDataAttrsOnly<IFlightOffer>).departFlight.departTimeUtc, (offerData as EntityDataAttrsOnly<IFlightOffer>).departFlight.departAirport.city.utcOffsetMin), 'day') },
              { ctrlKey: [...CtrlKey, 'Ticket', 'Details', 'Duration'] as ControlKey, caption: getI18nResName3('ticket', 'details', 'duration'), icon: 'timer', text: t(getI18nResName2('searchFlights', 'flightDuration'), getValueForFlightDurationFormatting((offerData as EntityDataAttrsOnly<IFlightOffer>).departFlight.departTimeUtc, (offerData as EntityDataAttrsOnly<IFlightOffer>).departFlight.arriveTimeUtc)) },
  ...
  return (offerData && offerData.kind === 'flights' && !!(offerData as EntityDataAttrsOnly<IFlightOffer>).arriveFlight) ? 
    ({
      ...
      details: {
        ...
        items: ([
          { ctrlKey: [...CtrlKey, 'Ticket', 'ReturnFlight', 'Details', 'Dates'], caption: getI18nResName3('ticket', 'details', 'date'), icon: 'calendar', text: d(getValueForFlightDayFormatting((offerData as EntityDataAttrsOnly<IFlightOffer>).arriveFlight!.departTimeUtc, (offerData as EntityDataAttrsOnly<IFlightOffer>).arriveFlight!.departAirport.city.utcOffsetMin), 'day') },
          { ctrlKey: [...CtrlKey, 'Ticket', 'ReturnFlight', 'Details', 'Duration'], caption: getI18nResName3('ticket', 'details', 'duration'), icon: 'timer', text: t(getI18nResName2('searchFlights', 'flightDuration'), getValueForFlightDurationFormatting((offerData as EntityDataAttrsOnly<IFlightOffer>).arriveFlight!.departTimeUtc, (offerData as EntityDataAttrsOnly<IFlightOffer>).arriveFlight!.arriveTimeUtc)) },
...
<template>
  <ClientOnly>
    <div class="booking-details-page">
      <ErrorHelm v-model:is-error="isError" class="booking-details-error-helm">
