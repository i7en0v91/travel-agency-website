    ...
    <NuxtErrorBoundary v-if="!isError" @error="onError">
      <div class="og-app-page">
        ...
        <div class="og-offer-summary">
          ...
          <div class="offer-review-summary">
            <span class="offer-score font-body color-secondary">
              {{ reviewScore!.toFixed(1) }}
            </span>
            <span class="offer-review-class font-body color-secondary font-bold">
              {{ $t(scoreClassResName) }}
            </span>
            <span class="offer-reviews-count font-body color-secondary">
              {{ reviewsCountText }}
            </span>
          </div>
        </div>
